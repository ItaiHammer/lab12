...
public class FamilyTree
{
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0)
			throw new TreeException("format error");
		...
		else
		{
			...
			if(parentNode == null)
			{
				throw new TreeException("parent node missing" + parent);
			}
		}
		
		// Add child nodes to parentNode. For each name in childrenArray, create a new node and add that node to parentNode.
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null)
			throw new TreeException("no name1");
